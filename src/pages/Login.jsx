...
const Login = () => {
    ...
    const { login, loginWithGoogle, nativeGoogleSignIn, user, redirectPending } = useAuth();
    const navigate = useNavigate();

    // Auto-redirect: fires when signInWithRedirect completes and user arrives back on this page
    useEffect(() => {
        if (user) {
    ...
    // Show a full-screen loading spinner while Google redirect result is being processed
    if (redirectPending) {
        return (
